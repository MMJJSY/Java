...
public class HashMap1 {
    public static void main(String[] args) {
        ...
        // 객체생성
        User u1 = new User("user01","victory");
        User u2 = new User("user02","choroky");
        User u3 = new User("user03","MMJJSY");
        ...
        // 검색 (Key로 검색)
        User user = userMap.get("user01");
        System.out.println(user);

        // 반복순회
        System.out.println("#반복");
        // 단일요소를 저장하는 List,Set은 쉽게 요소를 읽을 수 있지만
        // Map은 <Key,Value>쌍으로 존재하므로 Entry라는 클래스가 필요!
