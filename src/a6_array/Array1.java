...
// public의 의미가 누구나 import 할 수 있다는 의미지 어디에 있는지 자동으로 찾는다는 의미는 아니기 때문임!
...
public class Array1 {
    public static void main(String[] args) {
        // 배열 Array
        // 자료구조 (Date Structure)중에서 가장 단순한 구조
        // 자료구조의 종류 : 배열, 리스트, 세트, 맵, 트리.. 등이 있다.

        // 배열의 선언
        // 한줄로 선언
        int[] array1 = new int[3]; // int형 자료 3개를 힙 영역에 생성, 배열도 객체 but 생성자 아님
        // 두줄로 선언
        double[] array2;
        ...
        // 배열에 값을 대입하는 법
        array1[0] = 0; // 0번 index (=0번 자리)
        array1[1] = 10; // 1번 index
        ...
        // 배열의 초기값 정리
        // 배열은 힙 메모리에 생성되므로 기본 자료형의 경우, 각자의 초기값을 갖는다.
        // char ch = null
        // boolean  bool = false
