...
public class String1 {
    public static void main(String[] args) {
        ...
        System.out.println(str2); // 5.5
        // 일반적인 계산 목적으로 타입변환 할때는 사용x
